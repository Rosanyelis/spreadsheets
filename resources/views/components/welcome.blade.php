...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Certificados Generales Corp</a>
        ...
        <form method="POST" action="{{ url('/reporte-detallado-generar') }}">
            ...
            <div class="form-row" id="sinPension">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="eps1" value="{{ old('eps1') }}"
                        class="form-control @error('eps') is-invalid @enderror" id="eps">
                    @if ($errors->has('eps1'))
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="arl1" value="{{ old('arl1') }}"
                        class="form-control @error('arl') is-invalid @enderror" id="arl">
                    @if ($errors->has('arl1'))
            ...
            <div class="form-row" id="conPension">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="afp" value="{{ old('afp') }}"
                        class="form-control @error('afp') is-invalid @enderror" id="afp">
                    @if ($errors->has('afp'))
